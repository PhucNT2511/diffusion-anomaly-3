...
def create_argparser():
    defaults = dict(
        ...
        noised=True,
        iterations=800001,
        lr=1e-4, ########## Tăng lr để nhảy xuống cực trị nhanh ở thời điểm ban đầu, giảm dần ở steps sau
        weight_decay=0.0,
        anneal_lr=True,
        batch_size=4,
        microbatch=-1,
        schedule_sampler="uniform",
        resume_checkpoint="/kaggle/working/diffusion-anomaly-3/checkpoint/classifier/model600000.pt",
        log_interval=10,
