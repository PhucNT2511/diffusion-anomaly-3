##Không quá quan tâm, chủ yếu để cho việc tính toán dễ dàng hơn do chia thành các vùng tần số, và sử dụng dữ liệu rời rạc
# Chỉ áp dụng lên 2 chiều W, H. trong khi đó (N, C, H, W) là 1 dataloader thì N,C ko ảnh hưởng gì
